...
export default function About() {
    ...
    <div className="bg-gradient-to-br from-vibe-dark to-vibe-darker min-h-screen">
      <Head>
        ...
        <meta name="description" content="Learn about Full Vibes and our approach to coding with AI" />
      </Head>
      ...
      <header className="py-6 px-4 md:px-6 lg:px-8 backdrop-blur-sm bg-vibe-darker/70 sticky top-0 z-10">
        <div className="container mx-auto flex justify-between items-center">
          <div className="font-display font-bold text-2xl">
            <Link href="/">
              <span className="cursor-pointer bg-clip-text text-transparent bg-gradient-to-r from-vibe-pink to-vibe-blue">Full Vibes</span>
            </Link>
          </div>
          <nav>
      ...
      <main className="container mx-auto px-4 md:px-6 lg:px-8 py-12">
        <div className="max-w-3xl mx-auto">
          <h1 className="text-4xl font-bold font-display text-white mb-8 text-center">About Full Vibes</h1>
          
          <div className="bg-vibe-dark/60 backdrop-blur-lg rounded-xl p-8 mb-12 border border-white/5 shadow-lg shadow-vibe-purple/10"></div>
            <div className="flex flex-col md:flex-row items-center mb-8">
              ...
              <div className="md:w-2/3 md:pl-8">
                ...
                <p className="text-vibe-gray">
                  Our blog is dedicated to sharing insights, tutorials, and reflections on the evolving 
                  relationship between human creativity and AI assistance in software development.
                </p>
              </div>
            </div>
      ...
      <footer className="bg-vibe-darker text-center py-8 text-vibe-gray border-t border-white/5">
        <div className="container mx-auto px-4">
          <p className="font-mono text-sm">© {new Date().getFullYear()} Full Vibes. All rights reserved.</p>
        </div>
      </footer>
    </div>
  )
